...
data=np.genfromtxt("difusionCuadradoMantenidoFijas.dat")
x=data[:,0]
y=data[:,1]
X, Y = np.meshgrid(x, y)
foto1=data[:,2:103]
...
ax.set_ylabel('y(m)')
ax.set_zlabel('T(Celcius)')
ax.set_title('frontera fija cuadrado mantenido t=0')
plt.savefig("difusionFijaCuadradoMantenido0.png")
...
ax.set_ylabel('y(m)')
ax.set_zlabel('T(Celcius)')
ax.set_title('frontera fija cuadrado mantenido t=100')
plt.savefig("difusionFijaCuadradoMantenido100.png")
...
ax.set_ylabel('y(m)')
ax.set_zlabel('T(celcius)')
ax.set_title('frontera fija cuadrado mantenido t=2500')
plt.savefig("difusionFijaCuadradoMantenido2500.png")

data=np.genfromtxt("difusionCuadradoMantenidoFijastprom.dat")
t=data[:,0]
temp=data[:,1]
plt.figure()
plt.plot(t,temp,color="black")
...
plt.ylabel("temperatura(celcius)")
plt.title("temperatura promedio (frontera periodica)")
plt.savefig("temperaturaPromedioFronteraFijaMantenido.png")
